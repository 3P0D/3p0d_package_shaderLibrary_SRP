...
////// Emissive:
                ...
                float3 node_5580 = (lerp(_Shadows_var.rgb,(_Multiply_var.rgb*_Shadows_var.rgb),sin((_Speed_var*node_300.g)))*_Albedo_var.rgb);
