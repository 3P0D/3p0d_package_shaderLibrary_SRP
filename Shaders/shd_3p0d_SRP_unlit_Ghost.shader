...
/*SF_DATA;ver:1.40;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,cpap:True,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:0,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:5261,x:33085,y:32670,varname:node_5261,prsc:2|emission-5669-OUT;n:type:ShaderForge.SFN_Slider,id:7913,x:32291,y:33005,ptovrint:False,ptlb:Glow Power,ptin:_GlowPower,varname:_GlowPower_copy_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:2;n:type:ShaderForge.SFN_Color,id:4455,x:32133,y:32993,ptovrint:False,ptlb:Glow Color,ptin:_GlowColor,varname:_GlowColor_copy_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0,c2:1,c3:0.517005,c4:1;n:type:ShaderForge.SFN_Fresnel,id:7638,x:32133,y:32845,varname:node_7638,prsc:2|EXP-7888-OUT;n:type:ShaderForge.SFN_Multiply,id:4060,x:32291,y:32845,varname:node_4060,prsc:2|A-7638-OUT,B-4455-RGB;n:type:ShaderForge.SFN_Multiply,id:5669,x:32495,y:32821,varname:node_5669,prsc:2|A-4060-OUT,B-7913-OUT;n:type:ShaderForge.SFN_ValueProperty,id:7888,x:31929,y:32863,ptovrint:False,ptlb:Fresnel Power,ptin:_FresnelPower,varname:node_7888,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;proporder:7913-4455-7888;pass:END;sub:END;*/

Shader "3P0D's Shaders/SRP/Unlit/Unlit FXs/Unlit Ghost" {
    Properties {
