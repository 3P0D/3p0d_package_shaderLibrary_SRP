...
////// Emissive:
                ...
                float3 emissive = (_GlowPower_var*(pow(1.0-max(0,dot(normalDirection, viewDirection)),_FresnelPow_var)*_GlowColor_var.rgb));
